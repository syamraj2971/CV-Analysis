...
def get_landmark_model(saved_model=r'D:\hazna\malpractice\malpractice\src\static\manipulation\models\pose_model'):
    """
    ...
    # model = tf.saved_model.load(r"D:\Projects\Exam Hall\examcellautomation\static\manipulation\models\pose_model")
    return model
